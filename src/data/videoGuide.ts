...
export const videoGuideByDay: VideoGuideDay[] = [
  {
    day: 'Thứ 2',
    videos: [
      {
    ...
    videos: [
      {
        ...
        assetSrc: 'https://www.youtube.com/embed/4N9UhYEbbcg',
      },
      {
        title: 'Dead Bug',
        description: 'Giữ lưng dưới bám sàn và thực hiện động tác chậm.',
        assetSrc: 'https://www.youtube.com/embed/4XLEnwUr1OA',
      },
    ],
  },
  {
    ...
    videos: [
      {
        ...
        assetSrc: 'https://www.youtube.com/embed/MeIiIdhvXT4',
      },
      {
        title: 'Leg Press',
        description: 'Đặt chân đúng vị trí và không khoá gối ở đỉnh.',
        assetSrc: 'https://www.youtube.com/embed/IZxyjW7MPJQ',
      },
      {
        title: 'Walking Lunges',
        description: 'Bước dài và giữ thân người thẳng, gối sau gần chạm sàn.',
        assetSrc: 'https://www.youtube.com/embed/L8fvypPrzzs',
      },
    ],
  },
  {
    ...
    videos: [
      {
        ...
        assetSrc: 'https://www.youtube.com/embed/OUgsJ8-Vi0E',
      },
      {
        title: 'Donkey Kicks',
        description: 'Giữ lưng thẳng, đá chân lên và siết mông mỗi lần.',
        assetSrc: 'https://www.youtube.com/embed/9kDqTAl1YPA',
      },
      {
        title: 'Fire Hydrant',
        description: 'Mở chân sang ngang để tập cơ mông nhánh ngoài.',
        assetSrc: 'https://www.youtube.com/embed/x6tE3xgJ4fE',
      },
    ],
  },
  {
    ...
    videos: [
      {
        ...
        assetSrc: 'https://www.youtube.com/embed/KvMZJIB3YxM',
      },
      {
        title: 'Cobra Stretch',
        description: 'Mở rộng lưng, căng cơ bụng và hông nhẹ nhàng.',
        assetSrc: 'https://www.youtube.com/embed/2z61W5iS8Qs',
      },
    ],
  },
]
